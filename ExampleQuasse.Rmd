...
result <- optim_pso(objective_function=lik.nodrift,number_of_parameter=6,parameter_bounds=bounds,initial_estimates=p.start,projectfile=NULL, logfile="pso.log",tryCall=TRUE,max_number_of_iterations=20,verbose=0)
