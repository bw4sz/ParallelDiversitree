...
bounds<-cbind(rep(1e-10, number_of_parameters),
...
result <- optim_pso(objective_function=lik2,number_of_parameter=6,parameter_bounds=bounds,initial_estimates=p.start,projectfile=NULL, logfile="pso.log",tryCall=TRUE,verbose=TRUE)
